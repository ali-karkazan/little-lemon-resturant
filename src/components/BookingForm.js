                ...
                <form onSubmit={handleSubmit}>
                    <fieldset>
                        <div>
                            ...
                            <input id='book-date' value={date} onChange={
                        ...
                        <div>
                            ...
                            <select id="book-time" value={times} onChange={
                                (e) => setTimes(e.target.value)}>
                        ...
                        <div>
                            ...
                            <select id="book-occasion"
                                key={occasion}
                                value={occasion} onChange={(e) => setOccasion(
                                    e.target.value)}>
                            </select>
                        </div>
                        ...
                        <div className="btnReceive">
                            <input aria-label='On Click' type="submit"
